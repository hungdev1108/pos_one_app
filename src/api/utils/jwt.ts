...
export function extractUserInfo(token: string): UserInfo | null {
  try {
    ...
    return {
      ...
      userFullName: claims['http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname'] || '',
      companyName: claims['http://schemas.xmlsoap.org/ws/2005/05/identity/claims/system'] || '',
    };
  } catch (error) {
